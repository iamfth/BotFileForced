        ...
        try:
            ...
            CH_edit = await bot.edit_message_reply_markup(message.chat.id, message.message_id,
                                                          reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(
                                                              "Dapatkan Tautan", url=share_link)]]))
    ...
    if "aboutbot" in cb_data:
                ...
                [
                    [
                        InlineKeyboardButton("Channel",
                                             url="https://t.me/pemersatubangsaviralnih")
                    ],
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Asupan", url="https://t.me/pemersatubangsaviralnih")
                    ],
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. [Contact](https://t.me/xrinhere).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="WAJIB JOIN CHANNELNYA NGENTOT!!!! \n\n"
                         "JOIN DULU CHANNEL NYA >> @pemersatubangsaviralnih !!",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("WAJIB JOIN CHANNEL @pemersatubangsaviralnih 🥵", url=invite_link.invite_link)
                            ],
                            [
                ...
                await cmd.message.edit(
                    text="Something went Wrong. [Contact](https://t.me/xrinhere).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
